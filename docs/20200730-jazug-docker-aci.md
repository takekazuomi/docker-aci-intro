...
- 近江 武一
- 最近の活動
  - 会社製造 [baleen.studio](https://baleen.studio)
...
最近、Dockerを使うことが多い。コンテナで動くようにしておくと、環境再現性が高く開発効率があがる。6/25に、Docker cli のAzure統合がベータリリースしたので、今日は簡単な紹介をする。
...
今回のスライドは、Marpを使わせてもらいました。Docker で動かして書きました。
...
https://github.com/MicrosoftDocs/azure-docs/issues/36642
